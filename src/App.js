...
const tempMovieData = [
  // Temporary data for movies to display before fetching from the API
  {
    imdbID: "tt1375666",
    Title: "Inception",
    Year: "2010",
...
const tempWatchedData = [
  // Temporary data for watched movies
  {
    imdbID: "tt1375666",
    Title: "Inception",
    Year: "2010",
...
export default function App() {
  // State variables for query, movies, watched list, loading status, errors, and selected movie ID
  ...
  // Close the selected movie details view
  ...
  useEffect(
    function () {
      ...
      async function fetchMovies() {
        try {
          ...
          if (err.name !== "AbortError") {
            setError(err.message); // Show error message if not aborted
          }
        } finally {
      ...
      handleCloseMovie(); // Close movie details on new search
      fetchMovies();
